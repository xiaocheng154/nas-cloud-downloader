...
原作者：`xiaocheng154`  
原项目：[xiaocheng154/nas-cloud-downloader](https://github.com/xiaocheng154/nas-cloud-downloader)

> 署名要求：任何修改、衍生或重新分发的版本必须保留原作者 `xiaocheng154` 和上述原项目链接，并明确标注已修改。具体条款见 [LICENSE](LICENSE) 与 [NOTICE](NOTICE)。
...
允许使用、修改和分发，但源码、修改版、衍生版和重新分发版必须保留原作者 `xiaocheng154`、原项目链接及许可文件，并明确说明已经修改。详见 [LICENSE](LICENSE)。
